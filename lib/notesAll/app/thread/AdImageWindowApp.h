#ifndef ADIMAGEWINDOWAPP_H
#define ADIMAGEWINDOWAPP_H
...
class AdImageWindowApp : public QMainWindow
{
    Q_OBJECT
public:
    explicit AdImageWindowApp(QWidget *parent = 0);
