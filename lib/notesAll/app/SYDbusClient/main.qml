...
Item {
    ...
    Text {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                dbusclient.callService(textEdit.text)
            }
        }
    ...
    Text {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                dbusclient.callTypeService(keyTextEdit.text, valueTextEdit.text)
            }
        }
