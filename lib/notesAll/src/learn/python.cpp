...
void python::operatorString()
{
    /**
     http://www.cnblogs.com/huangcong/archive/2011/08/29/2158268.html
     http://www.yiibai.com/python/python_string.html#python_string
     数字变为字符串 str(4)
